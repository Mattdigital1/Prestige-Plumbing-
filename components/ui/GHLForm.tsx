...
export default function GHLForm({
  ...
  return (
    <>
      ...
      />
      <p className="px-4 py-3 text-xs leading-relaxed text-slate-500 bg-slate-50 border-t border-slate-100">
        ...
        <Link href="/privacy-policy" className="underline underline-offset-2 hover:text-slate-700 transition-colors">
          Privacy Policy
        </Link>
        .
      </p>
